...
tibble(erreur_modele_physique = donnees_stats_stations$z - donnees_stats_stations$mod)
```
...
diminiuer les valeurs du modèles physique.
...
Et voici donc les zones où les seuils précisés ont été dépassés.