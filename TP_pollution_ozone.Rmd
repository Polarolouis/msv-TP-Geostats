...
de mesures. C'est là que nous pouvons essayer de joindre les deux méthodes.
...
Et ci-dessus nous corrigeons donc les erreurs du modèles par les valeurs d'
erreurs prédites.
...
On retrouve alors notamment des niveaux de 
pollutions à l'ozone à Paris plus bas comme attendu aux vues des réactions qui 
ont lieu avec les produits de pollution automobile.
...
# Utilisation du modèles physique corrigé par le krigeage pour la prise de mesures
...
donnees_stats_physique$alerte_level <- cut(donnees_stats_physique$z_corr,
      ...
      labels = c("normal", "alerte", "mesure", "mesure_forte")
)
